...
define([
  ...
  "pciNferGapMatch/runtime/js/renderer",
  "OAT/util/event",
  ...
  var pciNferGapMatch = {
    ...
    setResponse: function (response) {
      var $container = $(this.dom),
        value =
          response && response.base ? parseInt(response.base.integer) : -1;
  ...
  qtiCustomInteractionContext.register(pciNferGapMatch);
});
